...
def main():
    ...
    perform_cyclic_voltammetry(args.days, args.cycles, args.electrode, args.testtype, args.scanrate, args.stepsize, args.scanwindow_lower, args.scanwindow_upper)
...
def perform_cyclic_voltammetry(days: int, cycles: int, electrode: str, testtype: str, scanrate: float, stepsize: float, scanwindow_lower: float, scanwindow_upper: float):
    """
